...
const LandingPageContent = ({ copy, locale }: LandingPageContentProps) => (
    <>
        <Hero copy={copy.hero} />
        <section id="demo" className="mx-auto mt-12 max-w-7xl scroll-mt-24 px-6 lg:scroll-mt-32">
        ...
        <section id="beta" className="mx-auto mt-24 max-w-7xl scroll-mt-24 px-6 lg:scroll-mt-32">

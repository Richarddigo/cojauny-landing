            ...
            <div className="relative mt-16 flex flex-col gap-10 lg:flex-row">
                    ...
                    {copy.screens.map((screen) => {
                        ...
                        return (
                            <button
                                ...
                                className={`group rounded-3xl border bg-white p-6 text-left shadow-lg transition focus-visible:outline-none ${isActive
                                        ? 'border-brand-300 shadow-soft-glow'
                            ...
                            >
                                ...
                                <h3 className="mt-4 text-2xl font-semibold text-slate-900">{screen.title}</h3>
                                <p className="mt-2 text-base text-slate-600">{screen.description}</p>
                            </button>
                        );
                    })}
                </div>
                <div className="relative flex flex-1 items-center justify-center">
                    <motion.div
                        ...
                        className="relative mx-auto w-[260px] max-w-full rounded-[3rem] border border-slate-200 bg-slate-900/90 p-4 shadow-2xl lg:w-[320px]"
                        aria-live="polite"
                    >

...
const Hero = ({ copy }: HeroProps) => (
    ...
    >
        ...
        <div className="mx-auto max-w-4xl px-4 pl-[calc(var(--social-bar-offset)+1rem)] sm:px-6">
            <span className="inline-flex items-center justify-center rounded-full border border-[rgba(91,123,255,0.4)] bg-[rgba(91,123,255,0.1)] px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-brand-400 sm:px-4">
                {copy.eyebrow}
            </span>

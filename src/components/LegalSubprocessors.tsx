        ...
        <div className="mt-12 space-y-6">
            {copy.providers.map((p) => (
                <article key={p.name} className="legal-card">
                    ...
                    <p className="mt-2 text-sm text-studio-muted"><strong>Purpose:</strong> {p.purpose}</p>
                    <p className="mt-1 text-sm text-studio-muted"><strong>Location:</strong> {p.location}</p>
                    <p className="mt-1 text-sm text-studio-muted"><strong>Security:</strong> {p.security}</p>
                </article>
            ))}
        </div>
